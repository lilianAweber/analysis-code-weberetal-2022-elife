function Do = tnueeg_spm_eeg_grandmean(S)
%TNUEEG_SPM_EEG_GRANDMEAN Modified SPM funtion for TNUEEG toolbox
...
% modified by L.Weber 15.11.18 to allow for different channel numbers across 
% data sets (l. 129)
