function [ condlist ] = dprst_correct_conditions_for_eyeblinktrials( condlist, trialStatsFile )
%DPRST_CORRECT_CONDITIONS_FOR_EYEBLINKTRIALS Removes eyeblink trials from the condition list
